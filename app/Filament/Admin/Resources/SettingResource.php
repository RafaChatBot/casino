...
class SettingResource extends Resource
{
    ...
    public static function sidebar(Model $record): FilamentPageSidebar
    {
        return FilamentPageSidebar::make()
            ->setTitle('GESTÃO DE AJUSTES')
            ->setDescription('Ajustes da plataforma')
            ->setNavigationItems([
                PageNavigationItem::make('GESTÃO SITE')
                    ->translateLabel()
                 ...
                 PageNavigationItem::make('GESTÃO ROLL-OVER')
                     ->translateLabel()
                ...
                PageNavigationItem::make('GESTÃO PAGAMENTO')
                    ->translateLabel()
                ...
                PageNavigationItem::make('GESTÃO DE BAUS')
                    ->translateLabel()
